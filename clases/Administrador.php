...
class Administrador extends Conexion{
    ...
    public function departamentos(){
        ...
        $resultado5 = mysqli_query($this->conexion, $query);
        return $resultado5;
    }
    ...
    public function roles(){
        ...
        //ejecutando la consulta => mysqli_query()
        $resultado4 = mysqli_query($this->conexion, $query);
        return $resultado4;
    }
    ...
    public function insertar(){
        ...
        $_POST['telefono'], $_POST['correo'], $_POST['password'], $_POST['departamento'])){
            ...
            $query = "INSERT INTO administrador(nombre, apellido, salario, carnet, telefono, correo, 
            password, id_departamento, id_rol, id_estado) 
            VALUES ('$this->nombre', '$this->apellido', $this->salario, '$this->carnet', 
            $this->telefono, '$this->correo', '$this->password', $this->id_departamento, 
            $this->id_rol, $this->id_estado)";
    ...
    public function getAdministrador(){
        $this->conectar();
        $query = "SELECT administrador.*, departamento.nombre AS departamento FROM administrador 
        INNER JOIN departamento ON administrador.id_departamento = departamento.id 
        WHERE administrador.id_estado = 1";
        $result = mysqli_query($this->conexion, $query);
        return $result;
    }
